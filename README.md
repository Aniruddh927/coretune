...
1. Create a repo on GitHub (e.g. `pc-parts-store`) — **public** (free Pages; a
...
2. Push this folder:
   ...
   git branch -M main
   git remote add origin https://github.com/YOURNAME/pc-parts-store.git
...
4. Your site is live at `https://YOURNAME.github.io/pc-parts-store/` in ~1 minute.
